...
Forkable is an MCP server and CLI that takes a GitHub token and operates on
...
Report security issues by opening a [private security advisory](https://github.com/mcp-tool-shop-org/forkable/security/advisories/new).
