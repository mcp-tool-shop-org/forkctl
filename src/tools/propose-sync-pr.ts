 ...
 *
 * The PR is the user's resolution surface. Forkable never force-pushes.
 */
export const proposeSyncPrTool: ToolDescriptor<ProposeSyncPrInput, ProposeSyncPrOutput> = {
  name: "forkable_propose_sync_pr",
  description:
    "Open a PR-based sync from upstream into a fork's branch. Use when forkable_sync returns SYNC_CONFLICT. Creates a fork-side branch at the upstream's HEAD SHA and opens a PR you can resolve interactively. Never force-pushes.",
...
function prBody(upstream: string, branch: string, sha: string): string {
  return `Auto-generated by [forkable](https://github.com/mcp-tool-shop-org/forkable).
